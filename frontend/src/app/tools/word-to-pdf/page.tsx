...
export default function WordToPdfPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      const response = await fetch('http://localhost:5000/api/document/docx-to-pdf', {
        method: 'POST',
        body: formData,
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          {loading && (
            <div className="mt-4 flex items-center justify-center">
              ...
              <span className="ml-3 text-gray-600">Converting to PDF...</span>
            </div>
          )}
        </div>
        ...
        <div className="mt-8 bg-white rounded-xl shadow-lg p-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">About Word to PDF Converter</h2>
          <div className="space-y-3 text-gray-600">
            <p>• Convert .docx files to PDF format</p>
            <p>• Preserves document structure and text</p>
            <p>• Universal PDF compatibility</p>
            <p>• Professional document sharing</p>
